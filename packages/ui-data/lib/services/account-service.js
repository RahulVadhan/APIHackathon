...
exports.getSubscriptionByAccountId = getSubscriptionByAccountId;
...
function getSubscriptionByAccountId(dispatch, accountId) {
  (0, _request["default"])(dispatch, "/aisp/accounts/".concat(accountId), 'GET', null, {}, function (response) {
    dispatch((0, _app.setData)(response));
  });
}
...
function Subscription() {
  alert('You have successfully subscribed to the service.');
}